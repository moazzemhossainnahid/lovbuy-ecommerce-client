    ...
    <div onClick={() => push(`/products/${_id}`)} className="mb-8 border cursor-pointer hover:shadow-md hover:-translate-y-3 duration-150 scroll-smooth rounded-xl">
      ...
      <div className="card-body p-0">
        ...
        <div className="px-4 text-md space-y-1 py-1">
          ...
          <div className="py-5">
            {
              sale ? <h3 className="text-gray-500 text-2xl font-bold"> <span className="text-xl">Price:</span> <span className="line-through">${price}</span> <span className="font-light text-gray-500">/</span><sub className="text-gray-500">${(price - (price * sale / 100)).toFixed(2)}</sub></h3> :
                <h3 className="text-gray-500 text-2xl font-bold"> <span className="text-xl">Price:</span> ${price}</h3>
            }
          </div>
        </div>
